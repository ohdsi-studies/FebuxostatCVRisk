...
OhdsiRTools::checkUsagePackage("FebuxostatCVRisk")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/FebuxostatCVRisk.pdf")
shell("R CMD Rd2pdf ./ --output=extras/FebuxostatCVRisk.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "FebuxostatCVRisk",
                                mode = "description",
